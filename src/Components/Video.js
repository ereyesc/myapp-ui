...
function Video() {
  ...
  const video = {
    ...
    url: "",
    img:
      "https://www.reportur.com/wp-content/uploads/2020/04/cancun-mara-lezama2.jpg",
    title: "The best of the best",
    description: "This is a test of the future site",
    tags: ["Race", "Color"],
  ...
  return (
    <div>
      ...
      <div className="playerContainer">
        ...
        <div className="infoContainer" style={window.innerWidth<480?{flexDirection: 'column'}:{flexDirection: 'row'}}>
          <div className="videoInfo">
            <div className="infoTitle">{video.title}</div>
            <div className="infoViews">
              {`${video.views} views`} &emsp; {`${video.uploaded}`}
            </div>
            <div className="infoIcons">
              <div className="like">
                <svg
                  ...
                  viewBox="0 0 20 20"
                  style={{ width: "30px", height: "30px", color: "#343a40" }}
                >
            ...
            <div className="infoContact"></div>
          </div>
          <div className="similarVideos" style={window.innerWidth<480?{width: '100%'}:{width: '40%'}}></div>
        </div>
      </div>
    </div>
  );
